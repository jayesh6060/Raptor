-- VTU 2022 SCHEME (COMPLETE 8-TERM CSE SYLLABUS)
-- Run this in the Supabase SQL Editor

-- 1. Clear old demo data to avoid confusion (Optional, but recommended for clean slate)
-- DELETE FROM public.courses WHERE code NOT LIKE 'BCS%';
...
-- 3. Assign all to Jayesh (Teacher)
DO $$
DECLARE
    teacher_uuid UUID;
...
-- 4. Enroll Malli (Student) in all Term 1-4 subjects for testing
DO $$
DECLARE
    student_uuid UUID;
    course_record RECORD;
